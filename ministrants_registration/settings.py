"""
Django settings for ministrants_registration project.
...
ROOT_URLCONF = 'ministrants_registration.urls'
...
WSGI_APPLICATION = 'ministrants_registration.wsgi.application'
...
DATE_FORMAT = 'j. F Y'  # Czech date format
TIME_FORMAT = 'H:i'     # Czech time format
